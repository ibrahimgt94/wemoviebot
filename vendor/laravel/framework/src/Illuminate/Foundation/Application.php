...
class Application extends Container implements ApplicationContract, CachesConfiguration, CachesRoutes, HttpKernelInterface
{
     ...
     * @return string
     */
    public function configPath($path = '', $dir_name = null)
    {
        $dir_name = is_null($dir_name) ? "config" : $dir_name;

        return $this->basePath.DIRECTORY_SEPARATOR.$dir_name.($path ? DIRECTORY_SEPARATOR.$path : $path);
    }
